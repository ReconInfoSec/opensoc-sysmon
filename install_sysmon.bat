...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/ReconInfoSec/opensoc-sysmon/master/sysmonconfig-export.xml','C:\ProgramData\sysmon\sysmonconfig-export.xml')"
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/ReconInfoSec/opensoc-sysmon/master/auto_update.bat','C:\ProgramData\sysmon\auto_Update.bat')"
